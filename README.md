...
```bash
# Replace v0.9.9 with the tag you want -- see the releases page for what's current.
curl -fsSLO https://github.com/minigame-labs/migo/releases/download/v0.9.9/migo-0.9.9-capi-android-arm64.tar.gz
tar xzf migo-0.9.9-capi-android-arm64.tar.gz
```
