...
```bash
# Replace v0.9.8 with the tag you want -- see the releases page for what's current.
curl -fsSLO https://github.com/minigame-labs/migo/releases/download/v0.9.8/migo-0.9.8-capi-android-arm64.tar.gz
tar xzf migo-0.9.8-capi-android-arm64.tar.gz
```
